...
actual suspend fun getFreeTranscriptionMemoryMb(): Long = memScoped {
    ...
    if (res != KERN_SUCCESS) {
        throw IllegalStateException("Failed to fetch vm statistics: $res")
    }
...
actual val minTranscriptionMemoryMb: Long = 1
